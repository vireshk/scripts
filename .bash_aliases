...
alias xenarm="/home/vireshk/work/repos/virtio/qemu//buildarm64/qemu-system-aarch64 -machine virt,virtualization=on -cpu cortex-a57 -machine type=virt -serial mon:stdio -device virtio-net-pci,netdev=net0 -netdev user,id=net0,hostfwd=tcp::8022-:22 -display none -m 8192 -kernel /home/vireshk/work/repos/virtio/xen/xen/xen -append \"dom0_mem=2G,max:2G dom0_max_vcpus=8 loglvl=all guest_loglvl=all\" -device guest-loader,addr=0x46000000,kernel=/home/vireshk/work/repos/kernel/barm64/arch/arm64/boot/Image,bootargs=\"root=/dev/sda2 console=hvc0 earlyprintk=xen\" -smp 8 -device virtio-scsi-pci -drive id=hd0,index=0,if=none,format=qcow2,file=/home/vireshk/work/repos/virtio/host-qemu/debian-buster-arm64.qcow2 -device scsi-hd,drive=hd0"
