...
alias htrading="htools; cd tradingpatterns"
...
alias updatejiramail="git send-email --confirm=always --cc-cmd=true --to-cmd=true pmwg-weekly-status.txt --to team-vt@linaro.org --to private-kwg@linaro.org --cc vireshk --cc 'Alex Bennée <alex.bennee@linaro.org>' --cc 'Lei Zhou <lei.zhou@linaro.org>'"
...
alias rusti2c="unlink $i2csock"0"; RUST_LOG=debug $rustvmmpath/vhost-device/target/debug/vhost-device-i2c -s $i2csock -c 1 -l 6:32"
...
alias rustchecks="cargo fmt --all -- --check --config format_code_in_doc_comments=true; cargo clippy --release --workspace --bins --examples --tests --benches --all-features --all-targets -- -D warnings -D clippy::undocumented_unsafe_blocks"
