...
# Rust
alias rustcoverage="echo \"cd vhost-device; pytest  rust-vmm-ci/integration_tests/test_coverage.py --no-cleanup; ./rust-vmm-ci/test_run.py\"; msudo docker run --device=/dev/kvm -it --security-opt seccomp=unconfined --volume $rustpath/vhost-device:/vhost-device --volume ~/.ssh:/root/.ssh rustvmm/dev:v12"
